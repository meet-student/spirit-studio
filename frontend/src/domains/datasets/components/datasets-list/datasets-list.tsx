  ...
  return (
    <EntityList columns={COLUMNS} scrollRef={containerRef}>
      <EntityList.Top>
        ...
        <EntityList.TopCell>{t('filters.tags')}</EntityList.TopCell>
        <EntityList.TopCell>{t('table.version')}</EntityList.TopCell>
        {onSortChange ? (
          <EntityList.SortableTopCell
            sortKey="updatedAt"
          ...
          <EntityList.TopCell>{t('table.lastUpdated')}</EntityList.TopCell>
        )}
        <EntityList.TopCell>{t('table.experiments')}</EntityList.TopCell>
      </EntityList.Top>
