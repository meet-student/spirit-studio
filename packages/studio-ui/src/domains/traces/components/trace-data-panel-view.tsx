...
export interface TraceDataPanelViewProps {
   ...
   * available in Spirit Studio" info notice when neither `onEvaluateTrace` nor
                      ...
                      {!isOnTracePage &&
                        ...
                        showUnavailableFeaturesMsg && (
                          <Notice variant="info" className="mb-6">
                            <Notice.Message>
                              Evaluating traces and saving them as dataset items is available in Spirit Studio (local or
                              deployed).
                            </Notice.Message>
                          </Notice>
                        )}
